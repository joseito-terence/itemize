...
const width = Dimensions.get('window').width - 148;
const aspectRatio = 797.5 / 834.5;
  ...
  return (
    <View className="items-center justify-center flex-1">
      <Svg
        ...
        />
        <Circle cx={559} cy={744.5} r={43} fill={colors.primary} />
        <Circle cx={54} cy={729.5} r={43} fill={colors.primary} />
        <Circle cx={54} cy={672.5} r={31} fill={colors.primary} />
        <Circle cx={54} cy={624.5} r={22} fill={colors.primary} />
      </Svg>
    </View>
  );
};

const UndrawVoid = React.memo(SvgComponent);
export default UndrawVoid;
